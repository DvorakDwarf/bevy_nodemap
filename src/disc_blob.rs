...
) -> UnGraph<NodeData, EdgeData>
{
    ...
    let origin_pos = get_start_pos(&local_graph, universe, locations, rng);
    ...
    return place_members(local_graph, universe, locations, rng);
}
...
) -> UnGraph<NodeData, EdgeData>
{
    ...
    local_graph = place_members(local_graph, universe, locations, rng);
